...
const getKanbanCard = (deal, handler, moveHandler) => {
  return (
    <>
...
function Deal({ type, deal, moveHandler }) {
      ...
      <>
        <Box sx={{ minWidth: 230 }}>
          <Card variant="outlined" sx={{ mb: "10px" }}>
            {getKanbanCard(deal, toggleDrawer, moveHandler)}
          </Card>
        </Box>
        <Drawer
          anchor={"right"}
